...
set "V_LOCAL=9.3.8"
:: REEMPLAZA ESTA URL con tu enlace RAW de GitHub (donde esté tu version.txt)
set "URL_VERSION=https://raw.githubusercontent.com/TU_USUARIO/TU_REPO/main/version.txt"
:: REEMPLAZA ESTA URL con tu enlace RAW del script .bat
set "URL_SCRIPT=https://raw.githubusercontent.com/TU_USUARIO/TU_REPO/main/RTIC_Hub_FCA.bat"
