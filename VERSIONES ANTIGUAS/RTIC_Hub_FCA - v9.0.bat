...
:: ==========================================
:: Creado por: Eichhh
:: Versión: 9.0 (Pantalla de inicio)
:: ==========================================
...
:: ==========================================
:: CONFIGURACION DE COLORES Y PANTALLA DE CARGA
:: ==========================================
:: Definimos el caracter ESC para usar colores avanzados (Naranja)
...
for /L %%i in (1,1,5) do (
    ...
    echo.
    echo.
    :: AQUI ESTA EL DISEÑO: RTIC (Blanco) | HUB (Fondo Naranja, Letra Negra) | FCA (Superindice Blanco)
    echo           %ESC%[1;37mRTIC %ESC%[48;2;255;165;0m%ESC%[30m HUB %ESC%[0m%ESC%[37mᶠᶜᵃ%ESC%[0m
    echo.
    echo           Creado por: Eichhh
    echo           Version: 9.0
    echo.
    echo.
