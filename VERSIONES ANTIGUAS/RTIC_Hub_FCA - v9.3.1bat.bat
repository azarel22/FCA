...
:: ==========================================
:: Creado por: Eichhh
:: Versión: 9.3.1 (Pantalla de inicio)
:: ==========================================
...
:: ==========================================
:: CONFIGURACION DE COLORES Y PANTALLA DE CARGA (V2.0)
:: ==========================================
...
for /L %%i in (1,1,%TOTAL_STEPS%) do (
    ...
    echo                                   %CG%Version: 9.3.1%RST%
    echo.
    
    :: Logica de barra de progreso
    set "BARRA=!BARRA!████"
    echo                               { !BARRA!#                     }
    echo                                Cargando modulos... %%i/7
